...
---
### Example - Initialize a new module project directory
...
---
### Example - Running the mod in MBBSEmu
...
-  MBBS 6.x dev files/tools installed at $(BBS)\SRC  (can be [found online](http://software.bbsdocumentary.com/IBM/DOS/MAJORBBS/))
